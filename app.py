...
with col1:
    st.subheader("🚗 Daily commute distance (in km) Km being the unit here")
    distance = st.slider("Distance", 0.0, 100.0, key="distance_input")

    st.subheader("💡 Monthly electricity consumption (in kWh) kWh being the unit here")
    electricity = st.slider("Electricity", 0.0, 1000.0, key="electricity_input")

with col2:
    st.subheader("🍽️ Waste generated per week (in kg) Kg being the unit herestr")
